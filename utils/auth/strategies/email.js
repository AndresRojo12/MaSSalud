...
async function sendConfirmationEmail(email, name) {
  try {
    ...
    <a href="https://massalud.onrender.com/" style="display: inline-block; background-color: #4CAF50; color: white; padding: 14px 20px; text-align: center; text-decoration: none; display: inline-block; border-radius: 4px; border: none; cursor: pointer;">Aceptar</a>
`;
